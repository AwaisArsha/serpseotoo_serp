        ...
        <div class="container container-xl-custom">
            <div class="row py-5">
                <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                    <h1 class="text-color-light font-weight-bold text-8">{{__("Pricing")}}</h1>
                </div>
                <div class="col-md-4 order-1 order-md-2 align-self-center">
                    <ul class="breadcrumb d-flex justify-content-md-end text-3-5">
                        <li><a href="{{url('/')}}" class="text-color-light font-weight-semibold text-decoration-none">HOME</a></li>
                        <li class="text-color-light font-weight-semibold active">{{__("Pricing")}}</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row text-center pb-5">
            <div class="col-md-9 mx-md-auto">
                <div class="overflow-hidden mb-3">
                    <h2 class="font-weight-semibold text-6 line-height-1 mb-3">Set up your account, start
                        tracking & planning right away!</h2>
                    <h4>
                        <strong></strong>
                        </h1>
                </div>
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                <div class="px-2">
                                    <div class="form-check form-switch form-switch-md mb-0">
                                        <input data-content-switcher data-content-switcher-content-id="pricingTable2" type="checkbox" class="form-check-input" checked>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body py-5">
                                            <div class="pricing-block">
                                                ...
                                                <div class="text-center mt-4 pt-2">
                                                    <a href="{{url('/upgrade/package/'.$package->id)}}" class="btn <?php if ($i == 2) {
                                                                                                                        echo 'btn-primary';
                                                                                                                    } else {
                                                                                                                        echo 'btn-dark';
                                                                                                                    }  ?> border-0 font-weight-semi-bold positive-ls-1 text-uppercase text-2-5 px-5 py-3">{{__("Upgrade Subscription")}}</a>
                                                </div>
