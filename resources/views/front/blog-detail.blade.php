                ...
                <div class="blog-posts single-post">
                    <article class="post post-large blog-single-post border-0 m-0 p-0">
                        ...
                        <div class="post-image ms-0">
                            ...
                            <img src="{{asset('project_images'.$blog->image)}}" style="width:100%; height:auto;" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" />
                        ...
                        <div class="post-content ms-0">
                            <h2 class="font-weight-semi-bold">{{$blog->title}}</h2>
                            <div class="post-meta">
