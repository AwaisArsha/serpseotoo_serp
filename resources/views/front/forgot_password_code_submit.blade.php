...
<div role="main" class="main">
        ...
        <div class="container container-xl-custom">
            <div class="row py-5">
                <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                    <h1 class="text-color-light font-weight-bold text-8">Inloggen/Register</h1>
                </div>
                <div class="col-md-4 order-1 order-md-2 align-self-center">
                    <ul class="breadcrumb d-flex justify-content-md-end text-3-5">
                        <li><a href="{{url('/')}}" class="text-color-light font-weight-semibold text-decoration-none">HOME</a></li>
                        <li class="text-color-light font-weight-semibold active">Inloggen/Register</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container py-4">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <h2 class="font-weight-bold text-5 mb-0">Change Password</h2>
                <form action="{{url('/user/change_password/save')}}" method="post" class="needs-validation">
                    @csrf
                  <input type="hidden" name="email" value={{$email}}>
                    <div class="row">
                        <div class="form-group col">
                            <label class="form-label text-color-dark text-3">Nieuw Wachtwoord<span
                    ...
                    <div class="row">
                        <div class="form-group col">
                            <label class="form-label text-color-dark text-3">Bevestig Wachtwoord<span
                                    class="text-color-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            <button type="submit"
                                ...
                                data-loading-text="Loading...">Doorgaan</button>
