                                            ...
                                            <div class="card-body py-5">
                                                ...
                                                <div class="pricing-block">
                                                    ...
                                                    <div class="text-center mt-4 pt-2">
                                                        <a href="{{url('/user/get/package/'.$package->id)}}" class="btn <?php if($i == 2) { echo 'btn-primary'; } else { echo 'btn-dark'; }  ?> border-0 font-weight-semi-bold positive-ls-1 text-uppercase text-2-5 px-5 py-3">{{__("Extend Subscription")}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
