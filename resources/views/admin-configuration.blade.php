...
<html lang="en">
 ...
 <main>
  ...
  <div id="msform" style="padding-top: 20px !important;"> 
    ...
    <fieldset>
      <form action="{{url('/admin-configuration-done')}}" method="post">
        @csrf
      <div class="form-group fg_2"> 
        <input type="text" class="form-control" placeholder="Admin Username" required name="username">
      </div> 
      <div class="form-group fg_2"> 
        <input type="password" class="form-control" placeholder="Admin Password" required name="password">
      </div> 
