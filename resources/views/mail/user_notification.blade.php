                                    ...
                                    <tr>
                                        <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left;" align="left">
                                            ...
                                            <p style="margin: 0 0 24px;">
                                                Below we have listed the details of all your domains.
                                                  You can login for more information...
                                            </p>
                                            ...
                                            <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <tr>
                                                    <td colspan="2" style="font-family: 'Montserrat',Arial,sans-serif;">
                                                        <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                            <tr style="font-size: 16px; letter-spacing: 0.5px;font-weight: 600; border-radius: 6px; background-color: #7984ac;  color: #ffffff; border: 1px solid #2f55d4;">
                                                            ...
                                                            <tr>
                                                                <td style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; padding-top: 10px;width: 30%; padding-left:10px;" width="80%">
                                                                    {{$domains}}
                                                                </td>
                                                                <td style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; padding-top: 10px;width: 30%; padding-left:10px;" width="80%">
                                                                    {{$keyword->keyword_name}}
                                                                </td>
                                                                <td align="right" style="font-family: 'Montserrat',Arial,sans-serif; font-size: 14px; text-align: right; width: 20%; padding-right:10px;" width="25%">
                                                                @php
                                                                  if($keyword->desktop_rank > 0) {
                                                        ...
                                                        <table style="font-family: 'Montserrat',Arial,sans-serif; margin-top: 24px; margin-bottom: 24px;" cellpadding="0" cellspacing="0" role="presentation">
                                                            <tr>
                                                                <td align="right" style=" border-radius: 4px;  font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                                                                    <a href="{{url('/')}}" style="padding: 8px 20px; outline: none; text-decoration: none; font-size: 16px; letter-spacing: 0.5px; transition: all 0.3s; font-weight: 600; border-radius: 6px; background-color: #2f55d4; border: 1px solid #2f55d4; color: #ffffff;">Ranking Checker &rarr;</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
