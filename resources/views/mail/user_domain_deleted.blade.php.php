            ...
            <table cellpadding="0" cellspacing="0" style="font-family: Nunito, sans-serif; font-size: 15px; font-weight: 400; max-width: 600px; border: none; margin: 0 auto; border-radius: 6px; overflow: hidden; background-color: #fff; box-shadow: 0 0 3px rgba(60, 72, 88, 0.15);">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        Hello <br>
                       It is to inform you that you have deleted your domain "{{$domain}}"".
                        <br>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 15px 24px;">
                            <a href="{{url('/')}}" target="blank" style="padding: 8px 20px; outline: none; text-decoration: none; font-size: 16px; letter-spacing: 0.5px; transition: all 0.3s; font-weight: 600; border-radius: 6px; background-color: #2f55d4; border: 1px solid #2f55d4; color: #ffffff;">Visit Site</a>
                        </td>
                    </tr>
