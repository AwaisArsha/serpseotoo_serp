                        ...
                        <tr>
                            ...
                            <td class="sm-py-32 sm-px-24" style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; padding: 48px; text-align: center;" align="center">
                                ...
                                <a href="{{url('/')}}">
                                    ...
                                    <img src="{{url('/project_images'.$logo)}}" width="155" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle;">
                                ...
                                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                    ...
                                    <tr>
                                        ...
                                        <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left;" align="left">
                                            ...
                                            <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Hello, a message has been received...</p>
                                                        ...
                                                        <table style="font-family: 'Montserrat',Arial,sans-serif; margin-top: 24px; margin-bottom: 24px;" cellpadding="0" cellspacing="0" role="presentation">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" style=" border-radius: 4px;  font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                                                                    ...
                                                                    <a href="{{url('/')}}" style="padding: 8px 20px; outline: none; text-decoration: none; font-size: 16px; letter-spacing: 0.5px; transition: all 0.3s; font-weight: 600; border-radius: 6px; background-color: #2f55d4; border: 1px solid #2f55d4; color: #ffffff;">Visit Site &rarr;</a>
