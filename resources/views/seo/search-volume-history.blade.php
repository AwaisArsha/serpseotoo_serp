        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{__("Search Volume History")}}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('/user/dashboard')}}">{{__("Dashboard")}}</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{url('/user/volume-history')}}">{{__("Search Volume History")}}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    <h5 style="margin-top: 0.5rem;">{{__("Last Queries will be displayed here.")}}</h5>
                </div>
            </div>
        </div>
                            ...
                            <table class="datatables-basic table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a href="{{url('/user/search-volume/detail/'.$data->search_volume_id)}}"><span
                                                        class="badge rounded-pill badge-light-warning me-1"><i
                                                            class="bi bi-eye" style="margin-right: 0.5rem;"></i>{{__("Detail")}}</span></a>
                                                <a href="{{url('/user/search-volume/delete/'.$data->search_volume_id)}}"><span
