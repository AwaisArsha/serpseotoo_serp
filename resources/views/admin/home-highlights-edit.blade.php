                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form form-horizontal" method="POST"
                                action="{{url('/admin/home-highlights/save/')}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{$home_highlights->id}}">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <div class="col-sm-3">
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="service" class="form-control"
                                                    ...
                                                    value="{{$home_highlights->description}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
