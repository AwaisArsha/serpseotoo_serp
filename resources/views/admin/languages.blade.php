        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Languages Data</h2>
                            ...
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                <table class="datatables-basic table dataTable no-footer dtr-column"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                ...
                                                aria-label="Date: activate to sort column ascending">Languages</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            <td valign="top" colspan="1" class="dataTables_empty">{{$language->display_name}}
                                            </td>
                                            <td valign="top" colspan="1" class="dataTables_empty">
                                                @if($language->status == '1')
                                                <a href="{{url('admin/language/inactive/'.$language->id)}}"><span
                                                        class="badge rounded-pill badge-light-success me-1">Active</span></a>
                                                @elseif ($language->status == '0')
                                                <a href="{{url('admin/language/active/'.$language->id)}}"><span
                                                        class="badge rounded-pill badge-light-secondary me-1">Inactive</span></a>
                                                @endif
                                            </td>
                                            <td valign="top" colspan="1" class="dataTables_empty">
                                                <a href="{{url('admin/language/edit/'.$language->id)}}"><span
