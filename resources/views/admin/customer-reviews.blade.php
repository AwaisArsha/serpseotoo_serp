                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{url('/admin/customer-reviews')}}">Reviews Data</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <section id="basic-datatable">
                            ...
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                ...
                                <table class="datatables-basic table dataTable no-footer dtr-column"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                ...
                                                aria-label="Date: activate to sort column ascending">Service</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                rowspan="1" colspan="1" style="width: 139px;"
                                                aria-label="Salary: activate to sort column ascending">Review</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            <td valign="top" colspan="1" class="dataTables_empty">{{$comment->cus_name}}
                                            </td>
                                            <td valign="top" colspan="1" class="dataTables_empty">{{$comment->service}}
                                            </td>
                                            <td valign="top" colspan="1" class="dataTables_empty">{{$comment->review}}
                                            </td>
                                            <td valign="top" colspan="1" class="dataTables_empty">
                                                @if($comment->status == '1')
                                                <a href="{{url('admin/customer-review/inactive/'.$comment->id)}}"><span
                                                        class="badge rounded-pill badge-light-success me-1">Active</span></a>
                                                @elseif ($comment->status == '0')
                                                <a href="{{url('admin/customer-review/active/'.$comment->id)}}"><span
                                                        class="badge rounded-pill badge-light-secondary me-1">Inactive</span></a>
                                                @endif
                                            </td>
                                            <td valign="top" colspan="1" class="dataTables_empty">
                                                <a href="{{url('admin/customer-review/edit/'.$comment->id)}}"><span
                                                        class="badge rounded-pill badge-light-warning me-1"><i
                                                            data-feather="edit-2" class="me-50"></i>Edit</span></a>
                                                <a href="{{url('admin/customer-review/delete/'.$comment->id)}}"><span
                ...
                <div class="modal modal-slide-in fade" id="modals-slide-in" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog sidebar-sm">
                        <form class="add-new-record modal-content pt-0" method="POST" action="{{url('/admin/customer-review/add')}}">
                            @csrf
                            ...
                            <div class="modal-body flex-grow-1">
                                ...
                                <div class="mb-1">
                                    <label class="form-label" for="basic-icon-default-post">Service</label>
                                    <input type="text" id="basic-icon-default-post" class="form-control dt-post"
                                        placeholder="Service" name="service" required>
                                </div>
                                <div class="mb-1">
                                    <label class="form-label" for="basic-icon-default-email">Review</label>
                                    <textarea type="text" id="basic-icon-default-email" class="form-control dt-email"
                                        placeholder="Review" required name="review" rows="5"></textarea>
                                </div>
                                <input type="submit"
