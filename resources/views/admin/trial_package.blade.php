            ...
            <div class="row">
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form form-horizontal" method="POST" action="{{url('/admin/trial_package/save/')}}">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <div class="col-sm-3">
                                                <label class="col-form-label" for="email-id">Trial Package Status</label>
                                            </div>
                                            <div class="col-sm-9">
                                                <select class="select2 form-select" id="select2-basic"
                                                    ...
                                                    } elseif($package->status == 0 || $package->status == null) {
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <div class="col-sm-3">
                                                <label class="col-form-label" for="email-id">Total Keywords
                                                    Limit</label>
                                            </div>
                                            <div class="col-sm-9">
                                                ...
                                                <input type="number" class="form-control dt-post"
                                                    placeholder="Total Keywords Limit" name="keywords_limit"
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @if($readonly != null)
                                                <input type="number" class="form-control dt-post"
                                                    placeholder="Domain Backlinks Limit" name="domain_backlinks_limit"
                                                    id="domain_backlinks_limit" required {{$readonly}}>
                                                @else
                                                <input type="number" class="form-control dt-post"
                                                    placeholder="Domain Backlinks Limit" id="domain_backlinks_limit"
                                                    name="domain_backlinks_limit" required
                                                    value="{{$package->domain_backlinks_limit}}">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @endphp
                                                <input class="form-check-input" type="checkbox"
                                                    id="keywords_planner_checkbox" name="keywords_planner_checkbox"
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @if($readonly != null)
                                                <input type="number" class="form-control dt-post"
                                                    placeholder="Domain Backlinks Limit"
                                                    name="domain_actual_backlink_limit"
                                                    id="domain_actual_backlink_limit" required {{$readonly}}>
                                                @else
                                                <input type="number" class="form-control dt-post"
                                                    placeholder="Domain Backlinks Limit"
                                                    id="domain_actual_backlink_limit"
                                                    name="domain_actual_backlink_limit" required
                                                    value="{{$package->domain_actual_backlink_limit}}">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="number" class="form-control dt-post"
                                                    ...
                                                    name="domain_backlinks_rows_limit" id="domain_backlinks_rows_limit"
                                                    required {{$readonly}}>
                                                @else
                                                <input type="number" class="form-control dt-post"
                                                    placeholder="Per Domain Backlinks Limit"
                                                    name="domain_backlinks_rows_limit" id="domain_backlinks_rows_limit"
                                                    required value="{{$package->domain_backlinks_rows_limit}}">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="number" class="form-control dt-post"
                                                    placeholder="Per Domain Backlinks Limit"
                                                    name="backlinks_workload_limit" id="backlinks_workload_limit"
                                                    required {{$readonly}}>
                                                @else
                                                <input type="number" class="form-control dt-post"
                                                    placeholder="Per Domain Backlinks Limit"
                                                    name="backlinks_workload_limit" id="backlinks_workload_limit"
                                                    required value="{{$package->backlinks_workload_limit}}">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @if($readonly != null)
                                                <input type="number" class="form-control dt-post"
                                                    placeholder="Per Domain Backlinks Limit" name="search_volume_limit"
                                                    id="search_volume_limit" required {{$readonly}}>
                                                @else
                                                <input type="number" class="form-control dt-post"
                                                    placeholder="Per Domain Backlinks Limit" name="search_volume_limit"
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input class="form-check-input" type="checkbox" id="serp_limit_checkbox"
                                                    name="serp_limit_checkbox" {{$serp_limit_checked}}>
                                                <label class="form-check-label" for="inlineCheckbox1">Unlimited</label>
                                                @php
                                                $readonly = null;
                                                ...
                                                @if($readonly != null)
                                                <input type="number" class="form-control dt-post"
                                                    placeholder="Per Domain Backlinks Limit" name="serp_limit"
                                                    id="serp_limit" required {{$readonly}}>
                                                @else
                                                <input type="number" class="form-control dt-post"
                                                    placeholder="Per Domain Backlinks Limit" name="serp_limit"
                                                    id="serp_limit" required value="{{$package->serp_limit}}">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <div class="col-sm-3">
                                                <label class="col-form-label" for="email-id">DataForSeo Labs API
                                                    Access</label>
                                            </div>
                                            <div class="col-sm-9">
                                                <select class="select2 form-select" id="select2-basic"
