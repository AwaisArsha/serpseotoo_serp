...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click"
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <!-- <a href="/" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ms-1">rankchecker</h2>
                                </a>-->
                                ...
                                <form class="auth-register-form mt-2" action="{{url('/admin/login/query')}}"
                                    method="POST">
                                    @csrf
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="register-email" name="username"
                                            placeholder="Username" value="{{$admin_email}}"/>
                                    </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge"
                                                ...
                                                placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                                aria-describedby="register-password" tabindex="3" value="{{$admin_password}}" />
                                    ...
                                    <div class="mb-1">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="rememberme"
                                                name="rememberme" tabindex="3" {{$is_remember}} />
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{asset('admin_assets/js/scripts/pages/auth-register.js')}}"></script>
    <!-- END: Page JS-->
