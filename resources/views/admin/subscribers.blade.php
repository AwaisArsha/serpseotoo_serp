        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Subscribers Data</h2>
                            ...
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                <table class="datatables-basic table dataTable no-footer dtr-column"
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            <td valign="top" colspan="1" class="dataTables_empty">{{$subscriber->email}}
                                            </td>
                                            <td valign="top" colspan="1" class="dataTables_empty">
                                                @if($subscriber->status == '1')
                                                <a href="{{url('admin/subscriber/inactive/'.$subscriber->id)}}"><span
                                                        class="badge rounded-pill badge-light-success me-1">Active</span></a>
                                                @elseif ($subscriber->status == '0')
                                                <a href="{{url('admin/subscriber/active/'.$subscriber->id)}}"><span
                                                        class="badge rounded-pill badge-light-secondary me-1">Inactive</span></a>
                                                @endif
                                            </td>
                                            <td valign="top" colspan="1" class="dataTables_empty">
                                                <a href="{{url('admin/subscriber/delete/'.$subscriber->id)}}"><span
